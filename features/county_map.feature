Feature: County Map Functionality For Getting Representatives
  ...
  Scenario: Clicking on San Francisco County to get the representatives
    Given that I am on state CA on map
    When I click on San Francisco County
    Then I should see London Breed, David Chiu, Manohar Raju, Joaquín Torres, Brooke Jenkins in the list of representatives
